...
public class VCB33KV extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vcb33_kv);
    ...
    public void setSaveVCB33(View v)
    {
        String value[]=new String[13];
        String table="VCB";
        String type="33KV"; //typeofVCB=33KV
        ...
        try{
            ...
            db.close();
            Toast.makeText(VCB33KV.this,"Saved Successfully",Toast.LENGTH_SHORT).show();
        ...
        startActivity(new Intent(VCB33KV.this,VCB11KV.class));
    }

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(VCB33KV.this,com.example.sbpd_app.Home.class));
    }
}
